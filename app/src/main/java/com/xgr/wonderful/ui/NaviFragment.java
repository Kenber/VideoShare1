...
public class NaviFragment extends Fragment implements OnClickListener
{
    ...
    private static final int LOGINFRAGMENT = 0;
    private static final int HOMEFRAGMENT = 1;
    private static final int SETTINGSFRAGMENT = 2;
    private static final int FEEDBACKFRAGMENT = 3;
    ...
    PersonalFragmentForLoginButton mPersonalfragment;
     ...
     */
    private void init() {
        navi_login = (TextView) rootView.findViewById(R.id.tv_navi_login);
    ...
    private void OnTabSelected(int index) {
        ...
        switch (index) {
            ...
            case LOGINFRAGMENT:
                BmobUser currentUser1 = BmobUser.getCurrentUser(mActivity);
                if(currentUser1 != null){
                    hideFragments(transaction);
                    if(null == mPersonalfragment){
                        mPersonalfragment = new PersonalFragmentForLoginButton();
                        transaction.add(R.id.center, mPersonalfragment);
                    }else {
