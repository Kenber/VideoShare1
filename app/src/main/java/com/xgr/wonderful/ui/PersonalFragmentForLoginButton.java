...
public class PersonalFragmentForLoginButton extends BaseHomeFragment implements OnClickListener{
	...
	public static PersonalFragmentForLoginButton newInstance(){
		PersonalFragmentForLoginButton fragment = new PersonalFragmentForLoginButton();
		return fragment;
	}
	...
	protected void setupViews(Bundle bundle) {
        ...
        Log.d("PersonalFragment", "mUser : " + (MyApplication.getInstance().getCurrentQiangYu() == null));//added
